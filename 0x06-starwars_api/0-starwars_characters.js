#!/usr/bin/node
/*
    Write a script that console.logs all characters of a Star Wars movie:
    ...
    3- get value of characters key of the json of prev request
    3- iterate over the characters's value list and send a get request to each item
    4- get the value of the key name for each request to a character url
 */
